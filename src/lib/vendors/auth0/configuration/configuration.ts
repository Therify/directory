...
/**
 * Auth0 Client ID - The client ID of your Auth0 application
 * @see https://auth0.com/docs/applications
 * @see https://auth0.com/docs/applications/set-up-an-application
 */
const AUTH0_CLIENT_ID = 'AUTH0_CLIENT_ID' as const;
/**
 * Auth0 Client Secret - The client secret of your Auth0 application
 * @see https://auth0.com/docs/applications
 */
const AUTH0_CLIENT_SECRET = 'AUTH0_CLIENT_SECRET' as const;
